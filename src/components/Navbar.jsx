      ...
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        <Link
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
            Ahmad &nbsp; <span className="sm:block hidden">| JS MAstery</span>
          </p>
        </Link>
        ...
        <div className="sm:hidden flex flex-1 justify-end ityem-center">
          <img
            ...
            alt="menu"
            className="w-[28px] h-[28px] opject-contain cursor-pointer"
          ...
          <div
            ...
            <ul className="list-non felx  justify-end items-start flex-col gap-4">
              {navLinks.map((link) => {
                return (
                  <li
                    key={link.id}
